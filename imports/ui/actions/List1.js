...
export const TASK_LISTS_SUBSCRIBE_START = 'TASK_LISTS_SUBSCRIBE_START';
export const TASK_LISTS_SUBSCRIBE_CREATE = 'TASK_LISTS_SUBSCRIBE_CREATE';
export const TASK_LISTS_SUBSCRIBE_WAITING = 'TASK_LISTS_SUBSCRIBE_WAITING';
export const TASK_LISTS_SUBSCRIBE_READY = 'TASK_LISTS_SUBSCRIBE_READY';
...
export function subscribeToTaskListsIfNeeded(){
  return (dispatch, getState) => {
    ...
    if( startSubscriptionToTaskLists(state) ){
      ...
      return dispatch( readyTaskListSubscription(state) );
    }
  }
}
...
export const TASK_LISTS_FETCH_START = 'TASK_LISTS_FETCH_START';
